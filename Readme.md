...
Prerequisito: haber tomado el taller de Integración continua de base de datos con liquibase, dado que ahi se generaran los ambientes y xml entre desarrollo y pruebas.
